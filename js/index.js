...
//3. if no game over page, we'll do going back
//in the future maybe you can only go back once. so you have one heart at the top left or bottom
//you can go back (by running from the troll) and if you fail the riddle again you die
//^per level??? since it's static, it will have different code :D
//3. possible test: layout test???
//for different devices
//does the software behave as intdended under the conditions it is supposed to be able to handle?
//are there any other risks?

//prof said to do multiple unit tests for one feature (of course)
